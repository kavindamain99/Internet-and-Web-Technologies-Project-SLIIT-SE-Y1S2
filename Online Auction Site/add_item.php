...
if (isset($_POST["item_submit"])) {
    ...
    if ($item_name && $fileName && $item_price && $due_date && $due_time &&  $fileName) {

        $sql = "INSERT INTO auc_sys_item (item_name, img_name, item_price, seller_id_fk, due_date, due_time) values('$item_name','" . $fileName . "', '$item_price', '$seller_id', '$due_date', '$due_time')";
                ...
                <div class="reg-form-div">
                    ...
                    <form method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        ...
                        <div class="div-row">
                            ...
                            <input class="input-field" type="text" name="item_name" value="<?php echo $item_name; ?>"><br>
                            <p class="error"><?php echo  $item_name_err ?> </p>
                        </div>

                        <div class="div-row">
                            <label class="input-label">Item Image</label>
                            <input class="input-field" type="file" name="file" id="fileToUpload">
                            <p class="error"> <?php echo  $file_upload_stat ?> </p>
                        </div>

                        <div class="div-row">
                            <label class="input-label">Price</label>
                            <input class="input-field" type="number" step="0.01" name="item_price" value="<?php echo $item_price; ?>"><br>
                            <p class="error"><?php echo  $item_price_err ?> </p>
                        </div>

                        <div class="div-row">
                            <label class="input-label"> Due date</label>
                            <input class="input-field" type="date" name="due_date" value="<?php echo $due_date; ?>">
                            <p class="error"><?php echo  $due_date_err ?> </p>
                        </div>

                        <div class="div-row">
                            <label class="input-label"> Due time</label>
                            <input class="input-field" type="time" name="due_time" value="<?php echo $due_time; ?>">
                            <p class="error"><?php echo  $due_time_err ?> </p>
                        </div>
