...
$sql = "SELECT * FROM auc_sys_rm_items WHERE seller_id = '$seller_id' AND purchase_status = 'cart' ";
...
<body>
    <div class="outer-div-div">
        <div>
            <h1 class="title">These items were not sold </h1>
            <p class="title-tag"> View your remaining items here</p>
            <hr class="hr-styles">
