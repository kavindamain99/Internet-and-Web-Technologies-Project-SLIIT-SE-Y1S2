    ...
    <div class="outer-div">
        <div class="inner-div">
            ...
            <div class="inner-inner-div">
                <a class="button" href="store.php">Bid items</a><br>
                <a class="button" href="my_bids_buyer.php">Show my bids</a><br>
                <a class="button" href="buyer_cart.php">Show my cart</a><br>
                <a class="button" href="update_buyer.php">Update profile</a><br>
                <a class="button" href="delete_buyer.php">Delete account</a><br>
